...
Run:
- tag: `shatner_cascade_v2`
- date/time: 2026-05-03T20:06:13.857134 → 2026-05-03T20:10:33.416711
...
|---|---|---|---|---|---|
| lifemap | — | Coming of Age | RED: state.session.currentEra='' / activeFocusEra='' did not match clicked era_id='coming_of_age' | …What was coming-of-age like for you, and what memories stand out from that time? (We can come back to the rest in a moment.) | Lori must respond, era_id matches, no menu/compound |

## Per-Turn Results

| Voice | Turn | Type | Narrator input | Lori reply | Q | Nest | Menu | Words | Refl | Voice rule | Pass |
|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| hearth | T1 | greeting | hello how are you | I'm excited to get started. Before we begin, I just wanted to let you know that I'll be capturing our conversation, including your voice, but only as audio recordings per turn. We won't be doing anyth | 0 | 0 | 0 | 36 | ✓ | ✓ | PASS |
| hearth | T2 | resistance | you already asked me that | I'm excited to get started. Before we begin, I just wanted to let you know that I'll be capturing our conversation, including your voice, but only as audio recordings per turn. We won't be doing anyth | 0 | 0 | 0 | 36 | ✓ | ✓ | PASS |
| hearth | T3 | story_seed | Mother had a silk ribbon from her wedding. She'd take it out once a year, touch it, and put it back. | Would you like to tell me a little bit more about your mother and her wedding? | 1 | 0 | 0 | 16 | ✓ | ✓ | PASS |
| hearth | T4 | uncertainty | I don't remember much about the trip over | It can be tough to remember everything from a long time ago. Let's focus on getting to know you better. Can you start by telling me, what's your name? | 1 | 0 | 0 | 29 | ✓ | ✓ | PASS |
...
|---|---|---|---|---|---:|---:|---|
| Coming of Age (coming_of_age) | ✗ | (empty) | ✓ | ✓ | 1 | 0 | RED |
