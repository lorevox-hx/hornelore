...
Run:
- tag: `lifemap_probe_v1`
- date/time: 2026-05-03T20:22:13.120262 → 2026-05-03T20:28:04.712320
...
|---|---|---|---|---|---:|---:|---:|---:|---|---|---|
| hearth | T1 | greeting | hello how are you | I'm an AI, so I don't have feelings, but I'm here to listen and chat with you. How are you doing today? | 1 | 0 | 0 | 22 | ✓ | ✓ | PASS |
| hearth | T2 | resistance | you already asked me that | I'm an AI, so I don't have feelings, but I'm here to listen and chat with you. How are you doing today? | 1 | 0 | 0 | 22 | ✓ | ✓ | PASS |
| hearth | T3 | story_seed | Mother had a silk ribbon from her wedding. She'd take it out once a year, touch it, and put it back. | That's a beautiful image. It sounds like the silk ribbon held a special significance for your mother. What was the occasion when she would take it out each year? | 1 | 0 | 0 | 29 | ✓ | ✓ | PASS |
| hearth | T4 | uncertainty | I don't remember much about the trip over | It can be tricky to recall memories from early childhood. Let's focus on the present moment. What's your name, if you feel comfortable sharing it with me? | 1 | 0 | 0 | 27 | ✓ | ✓ | PASS |
