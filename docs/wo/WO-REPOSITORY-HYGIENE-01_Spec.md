...
**Status:** ACTIVE — commit 1 (indexes) delivered and **awaiting review**. No file moved.
**Opened:** 2026-08-28
...
| 1 | **Indexes only** | This file, `docs/INDEX.md`, `docs/BACKLOG.md`, `docs/archive/INDEX.md`, `scripts/INDEX.md`, the audit verbatim, the verification addendum. **No moves** | **delivered, awaiting review** |
| 2 | Control authority | `HANDOFF.md` → current state and next action. Checklist → active/next/deferred. README → product and operation, not commit history. `CLAUDE.md` → durable doctrine, with the corrections in `BACKLOG.md` §4. Changelog snapshot archived, small index exposed | not started |
