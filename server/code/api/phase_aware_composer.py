...
# Hornelore project root. We resolve from this module's location (three
# directories up: api/phase_aware_composer.py → api → code → server → ROOT).
_THIS_DIR = Path(__file__).resolve().parent
_PROJECT_ROOT_CANDIDATES = [
    _THIS_DIR.parent.parent.parent,        # server/code/api -> Hornelore root
...
def _resolve_bank_path() -> Optional[Path]:
    ...
    env_path = os.environ.get("HORNELORE_QUESTION_BANK_PATH")
