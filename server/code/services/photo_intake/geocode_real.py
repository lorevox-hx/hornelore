...
Why Nominatim instead of Google Maps:
  ...
  - Hornelore is a family-sized installation; rate limits (1 req/sec
    per Nominatim's usage policy) are not an issue.
  - The visualschedulebot photo admin uses Google Maps; if Hornelore
...
_USER_AGENT = "Hornelore/1.0 (Lori companion app; family deployment; chris@hornelore.local)"
