...
> | **next** | **C-4E — birth / death / places** (death event and deceased status in one Save; explicit Choose existing / Create new place, never merged from a string) | **D carries the WHOLE authority ledger, checkpoint B1–B17**, not a short list. The real-narrator identity floor stays an **open D-0 decision** |
>
