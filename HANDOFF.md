...
> | **next** | **Stack-on smoke (one field → real PATCH → reload)**, then **C-3** people and relationships | Brief reviewed against the tree: checkpoint "Batch C — review". One gap, recoverable Remove, is designed there as a removal state (`0065`, C-6). The next stack start is the first Phase 3 product session |
>
