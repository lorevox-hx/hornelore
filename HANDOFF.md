...
> | **C-2 status** | **ACCEPTED / CLOSED 2026-09-24**: R7 live PASS (PATCH 200, rev 1→2, reload persistence, no QF takeover, zero view writes) · `.venv` 119 OK, 0 skips, 1 expected failure · Operator Intake 5/5 | (checkpoint "C-2 — LIVE ACCEPTANCE FAILED"). Do NOT start C-3 |
...
> | **next** | **C-3** — people and relationships through the Life Record writer; Family becomes a derived view. No cleanup phase in between | Carried to D: chat identity onboarding → legacy PUT (D-3), `lorevox_proj_draft_` on switch, Bug Panel Bio editor, readiness/identity floor (D-0) |
>
