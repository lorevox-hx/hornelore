...
> | **next** | **C-2b**: Bio Builder consolidation (Questionnaire · Sources & Notes · Review · Family (draft) · ⋯ Legacy); remove Reset Identity + Life Threads from nav; cut Family Tree's legacy write; name + revision in header; normalise the retired stored style; stale truth wording. Behaviour convergence stays in D. Then **C-3** | Brief reviewed against the tree: checkpoint "Batch C — review". One gap, recoverable Remove, is designed there as a removal state (`0065`, C-6). The next stack start is the first Phase 3 product session |
>
