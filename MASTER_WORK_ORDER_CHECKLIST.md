...
| # | Work | State |
|---:|---|---|
| 1 | **`WO-LORI-ARCHIVE-TO-MEMOIR-02`** — Phase 1 | 🔵 **CURRENT, IN IMPLEMENTATION.** Phase 0 accepted at `fdaa255`; the corrected launcher is pushed at `369e9aa`; the fresh live memoir-chain run remains pending. Phase 2, the read-only 38-turn destination ledger, has not started. State and mutation authority: `HANDOFF.md` §9. [Work order](docs/wo/WO-LORI-ARCHIVE-TO-MEMOIR-02.md) |
