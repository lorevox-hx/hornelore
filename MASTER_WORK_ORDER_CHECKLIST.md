...
**Active as of:** 2026-08-26 (`WO-LORI-CONVERSATION-TO-LIFE-MAP-MEMOIR-01` ACCEPTED AND COMPLETE. **Profile Seed reachability: Phase 0 ACCEPTED (`661aa95`); Phase 1 — server authority — ACCEPTED (`1288baa`); Phase 2 — prompt and committed-turn wiring — IS IN IMPLEMENTATION and is NOT accepted.**)
