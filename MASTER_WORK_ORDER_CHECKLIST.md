...
## Travel Doc unification — WO-TRAVEL-DOC-UNIFY-01 (Phase 3D CODE-LANDED 2026-07-25)
...
**A phase is a scope wall — Phase 3D is a separate session.**

**Blocking constraints carried into Phase 3D (each already cost real debugging
once, or would):**
