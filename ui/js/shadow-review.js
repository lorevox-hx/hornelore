/* ═══════════════════════════════════════════════════════════════
   ...
   Exposes: window.HorneloreShadowReview
═══════════════════════════════════════════════════════════════ */

(function (global) {
  "use strict";

  if (global.HorneloreShadowReview) return;
  ...
  async function _commitResolutions(sources) {
    ...
    if (blocked > 0 && sr.conflicts.length > 0) {
      ...
      if (global.HorneloreConflictConsole && global.HorneloreConflictConsole.render) {
        global.HorneloreConflictConsole.render();
      }
    }
  }
